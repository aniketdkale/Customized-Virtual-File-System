...
void man(char *name)
{
    ...
    {
        printf("Description: used to read data from the regular file\n");
        printf("Uses: read file_name No_of_Bytes_To_Read\n");
    }
    else if(strcmp(name, "write") == 0)
    {
        printf("Description: used to write data from the regular file\n");
        printf("Uses: write file_name\n After this enter the  data that we want to write.\n");
    }
    ...
    {
        printf("Description: used to dislpay information of the file\n");
        printf("Uses: stat File_name\n");
    }
    else if(strcmp(name, "fstart") == 0)
    {
        printf("Description: used to dislpay information of the file\n");
        printf("Uses: stat File_Description\n");
    }
    else if(strcmp(name, "truncate") == 0)
    {
        printf("Description: used to remove data from file\n");
        printf("Uses: truncate File_name\n");
    }
    else if(strcmp(name, "open") == 0)
    {
        printf("Description: used to open existing file\n");
        printf("Uses: open File_name mode\n");
    }
    else if(strcmp(name, "close") == 0)
    {
        printf("Description: used to close opened file\n");
        printf("Uses: close File_name\n");
    }
    else if(strcmp(name, "closeall") == 0)
    {
        printf("Description: used to close all opened file\n");
        printf("Uses: closeall\n");
    }
    else if(strcmp(name, "lseek") == 0)
    {
        printf("Description: used to change the file offset\n");
        printf("Uses: lseek File_Name ChangeInOffset StartPoint\n");
    }
    else if(strcmp(name, "rm") == 0)
    {
        printf("Description: used to delete the file\n");
        printf("Uses: rm File_name\n");
    }
    else
    {
...
void DisplayHelp()
{
    ...
    printf("write : to write the content form file\n");
...
void CreateDILB()
{
    ...
    printf("DILB created succesfull\n");
}
...
int LseekFile(int fd, int size, int from)
{
    ...
    if((UFDTArr[fd].ptrfiletable->mode == READ) || (UFDTArr[fd].ptrfiletable->mode == READ+WRITE))
    {
        ...
        else if(from == END)
        {
            ...
            if(((UFDTArr[fd].ptrfiletable->readoffset) + size) < 0)     return 0;
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminateing the Marvellous Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"truncate") == 0)
            {
                ...
                if(ret == -1)
                    printf("Error : Incorrect parameterr\n");
            }
            else
            {
                printf("\nERROR : Command not found....\n");
